...
with st.sidebar:
    ...
    # Cấp độ bền bê tông (English name)
...
with tab1:
    st.markdown("**Phân bố Momen M11 - 3D View**")
    ...
    with col_3d:
        ...
        # Vẽ 3D Surface
        fig_m11_3d = go.Figure(data=[go.Surface(
            x=x_vals,
            y=y_vals,
            z=Z_M11,
            colorscale='Viridis',
            hovertemplate='X: %{x:.2f}m<br>Y: %{y:.2f}m<br>M11: %{z:.2f} kNm<extra></extra>'
        )])
        
        fig_m11_3d.update_layout(
            title="M11 Bending Moment - 3D",
            scene=dict(
                xaxis_title="Length (m)",
                yaxis_title="Width (m)",
                zaxis_title="Moment (kNm)"
            ),
            height=500,
    ...
    with col_2d:
        st.write("**2D Top View (Chiếu bằng)**")
        # Vẽ 2D Heatmap
        fig_m11_2d = go.Figure(data=go.Heatmap(
            z=Z_M11,
            x=x_vals,
            y=y_vals,
            colorscale='Viridis',
        ...
        fig_m11_2d.update_layout(
            title="M11 Bending Moment - 2D Top View",
            xaxis_title="Length (m)",
            yaxis_title="Width (m)",
            height=500,
...
with tab2:
    st.markdown("**Phân bố Momen M22 - 3D View**")
    ...
    with col_3d:
        st.write("**3D Visualization**")
        # Vẽ 3D Surface
        fig_m22_3d = go.Figure(data=[go.Surface(
            x=x_vals,
            y=y_vals,
            z=Z_M22,
            colorscale='Viridis',
            hovertemplate='X: %{x:.2f}m<br>Y: %{y:.2f}m<br>M22: %{z:.2f} kNm<extra></extra>'
        )])
        
        fig_m22_3d.update_layout(
            title="M22 Bending Moment - 3D",
            scene=dict(
                xaxis_title="Length (m)",
                yaxis_title="Width (m)",
                zaxis_title="Moment (kNm)"
    ...
    with col_2d:
        st.write("**2D Top View (Chiếu bằng)**")
        # Vẽ 2D Heatmap
        fig_m22_2d = go.Figure(data=go.Heatmap(
            z=Z_M22,
            x=x_vals,
            y=y_vals,
            colorscale='Viridis',
        ...
        fig_m22_2d.update_layout(
            title="M22 Bending Moment - 2D Top View",
            xaxis_title="Length (m)",
            yaxis_title="Width (m)",
            height=500,
            margin=dict(l=20, r=20, t=30, b=20)
